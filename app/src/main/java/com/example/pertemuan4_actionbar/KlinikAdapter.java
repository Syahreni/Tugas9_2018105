...
public class KlinikAdapter extends RecyclerView.Adapter<KlinikAdapter.KlinikViewHolder> {
        ...
        int images[];
        Context context;
        public KlinikAdapter(Context ct, String s1[], String s2[], String s3[], int img[]){
            context = ct;
            data1 = s1;
            data2 = s2;
            data3 = s3;
        ...
        @NonNull
        @Override
        public KlinikAdapter.KlinikViewHolder
        onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
            View view = layoutInflater.inflate(R.layout.item_klinik, parent, false);
            return new KlinikViewHolder(view);
        }
        @Override
        public void onBindViewHolder(@NonNull KlinikAdapter.KlinikViewHolder holder, int position) {
